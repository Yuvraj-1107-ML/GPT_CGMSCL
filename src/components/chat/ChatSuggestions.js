 ...
 * Copilot-style floating suggestions with a prompt gallery button,
 * matching the igl.html chat design.
 */
function ChatSuggestions({ onSelectSuggestion, onOpenPromptGallery }) {
  return (
    <>
      {suggestionPills.map((suggestion) => (
        <button
          key={suggestion}
          className="floating-suggestion-pill"
          type="button"
