...
export const globalPromptCards = [
  {
    ...
    prompts: [
      ...
      'Tender Status of A Category or High Value Drug',
      'Tender Status of B Category or Medium Value Drug ',
      'Tender Status of C Category or or Low Value Drug',
      ...
      'provide overall tender status on dpdmis',
      'provide overall tender status on dpdmis status action is re-tender and Fresh Tender grand total in the last row',
      'provide overall tender status on dpdmis provide where tender is live and grand total in the last row',
